...
PHP_REDIS_API RedisSock* redis_sock_create(char *host, int host_len, unsigned short port, char* auth, int auth_len, double timeout, int persistent, char *persistent_id, long retry_interval, zend_bool lazy_connect);
